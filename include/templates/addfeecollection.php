...
<div class="card">
                                    ...
                                    <div class="card-header">
                                        ...
                                        <label>Receipt Number<span class="text-danger">*</span></label>
                                            <input type="number" tabindex="1" type="text" value="<?php if(isset($receiptnumber)) echo $receiptnumber; ?>" id="receiptnumber"  name="receiptnumber" placeholder="Enter The Receipt Number" class="form-control" >
                                        ...
                                        <label>Register Number<span class="text-danger">*</span></label>
                                            <input type="text" tabindex="1" type="text" value="<?php if(isset($registernumber)) echo $registernumber; ?>" id="registernumber"  name="registernumber" placeholder="Enter The Register Number" class="form-control" >
                                       ...
                                       <div class="col-sm-4">
                                        <div class="form-group">
                                              ...
                                              <select id="studentid" tabindex="2" name="studentid" class="form-control">
                                               <option value="">-- Select Student Name --</option>                               
                                                <?php                               
                                                 $records = mysqli_query($mysqli, "SELECT studentid, studentname From student");  
                                                 while($data = mysqli_fetch_array($records))
                                                 {
                                                   echo "<option value='". $data['studentid'] ."'>" .$data['studentname'] ."</option>";
                                                 }
                                                   ?>  
                                                 </select>                          
                                           <label><span id="studentidcheck" class="text-danger">Select the Student Name</span></label>
                                          </div>
                                          </div>
